...
from crane_interface.msg import Craneparameters
...
class Simulator(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Craneparameters, 'thetaBoomValue', self.listener_callback, 5)
        self.subscription
        ...
        try:
            while rclpy.ok():
                ...
                joint_state.position = [self.theta_boomm]
                ...
                odom_trans.transform.rotation = \
                    euler_to_quaternion(0, self.theta_boomm, 0) # roll,pitch,yaw
